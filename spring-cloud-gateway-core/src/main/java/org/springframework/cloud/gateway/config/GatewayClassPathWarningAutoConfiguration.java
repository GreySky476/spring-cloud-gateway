...
/**
 * GatewayClassPathWarningAutoConfiguration 用于检查项目是否正确导入 spring-boot-starter-webflux 依赖，而不是导入 spring-boot-starter-web
 */
@Configuration
...
public class GatewayClassPathWarningAutoConfiguration {
	...
	/**
	 * 用于检查是否错误导入了 spring-boot-starter-web 依赖
	 */
	@Configuration
	...
	/**
	 * 检查项目是否导入了 spring-boot-starter-webflux 依赖
	 */
	@Configuration
